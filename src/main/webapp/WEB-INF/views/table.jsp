    ...
    <section class="workspace">
        ...
        <section class="table-layout">
            <form class="editor" @submit.prevent="submitProduct">
                ...
                <label>
                    SKU
                    <input v-model.trim="form.sku" placeholder="SKU-2001" maxlength="30" pattern="[A-Za-z0-9-]+" title="Use letters, numbers, and hyphens only." required>
                </label>
                <label>
                    Product name
                    <input v-model.trim="form.name" placeholder="Mechanical mouse" maxlength="80" required>
                </label>
                <label>
                    Category
                    <input v-model.trim="form.category" placeholder="Hardware" maxlength="50" required>
                </label>
                <div class="fields">
                    <label>
                        Price
